...
class PointTransformer(nn.Module):
    ...
    def forward(self, pts):
        ...
        # group_gcn_feat = self.gcn_block(group_input_tokens) # B G N
        # Concat all features
        concatenated_feature = torch.cat((group_input_tokens, pointnet2_feature), dim=-1) # [B, G, 384+384+512 = 1280]
        # concatenated_feature = torch.cat((group_input_tokens, pointnet2_feature), dim=-1) # [B, G, 256+256 = 512]
        return concatenated_feature
