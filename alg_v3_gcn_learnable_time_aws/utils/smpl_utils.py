...
def joint_id_to_name(idx: int) -> str:
    d = {
    0: 'Pelvis',
    1: 'L_Hip',
    2: 'R_Hip',
...
# Copied from https://files.is.tue.mpg.de/black/talks/SMPL-made-simple-FAQs.pdf
...
def get_smpl_joint_num():
    return 24


# Modified from https://github.com/ZhimingZo/Modulated-GCN/blob/main/Modulated_GCN/Modulated-GCN_benchmark/data/common/graph_utils.py
def get_smpl_adj_matrix(normalize=True):
    connected = get_smpl_skeleton()
    adj = np.zeros(shape=(get_smpl_joint_num(), get_smpl_joint_num()))
